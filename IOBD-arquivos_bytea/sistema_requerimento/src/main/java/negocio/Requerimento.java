...
public class Requerimento {
    ...
    public String anexoEncode() {
        if (this.anexo != null) return Base64.getEncoder().encodeToString(this.anexo);
        return null;
    }
    ...
    public String toString() {
        return "Requerimento [id=" + id + ", dataHoraAbertura=" + dataHoraAbertura + ", dataHoraEncerramento="
                + dataHoraEncerramento + ", observacao=" + observacao + ", status=" + status + ", anexo="
                + Arrays.toString(anexo) + ", aluno=" + aluno + ", tipoRequerimento=" + tipoRequerimento + "]";
    }
