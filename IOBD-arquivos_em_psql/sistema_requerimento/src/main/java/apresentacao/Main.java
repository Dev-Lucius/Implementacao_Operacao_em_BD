    ...
    public static void main(String[] args) throws SQLException {
        ...
        Javalin.create(config -> {
            ...
            config.routes.get("/requerimento", ctx -> {
                // Crio o Map para passar os dados ao HTML
                Map<String, Object> map = new HashMap<>();

                // Busco a lista de todos os requerimentos do banco (assumindo que seu RequerimentoDAO possui o método listar)
                map.put("vetRequerimento", new RequerimentoDAO().listar());

                // Renderizo a página de listagem de requerimentos
